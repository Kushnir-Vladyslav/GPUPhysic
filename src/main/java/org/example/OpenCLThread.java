...
public class OpenCLThread extends Task<Void> {
    @Override
    public Void call () {
...
//            }
            ...
            long commandQueue = CL10.clCreateCommandQueue(context, device, CL10.CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE,(IntBuffer) null);
            ...
            URL URLKernelSource = getClass().getResource("physicCalculation.cl");;

            assert URLKernelSource != null;
            String kernelSource = Files.readString(Paths.get(URLKernelSource.toURI()));
            ...
            long kernel = CL10.clCreateKernel(program, "physicCalculation", (IntBuffer) null);
